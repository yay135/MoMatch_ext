...
declare -a arr0=("gestureWatch/lite_server/mirror/lite_server.jar" "gestureWatch/lite_server/mirror/lite_server.jar" "rotationIoT/lite_server/mirror/lite_server.jar" "watchwalk/lite_server/mirror/lite_server.jar")
